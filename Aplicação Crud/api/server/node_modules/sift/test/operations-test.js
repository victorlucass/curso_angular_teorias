...
describe(__filename + '#', function () {
    ...
    [
        ...
        [{field: {$exists: false}}, [{a: 1}, {a: 2, field: 5}, {a: 3, field: 0}, {
            a: 4,
            field: undefined
        }, {a: 5}], [{a: 1}, {a: 5}]],
        ...
        [{$and: [{field: {$not: {$type: String}}}, {field: {$ne: null}}]}, [{a: 1, field: 1}, {
            a: 2,
            field: '2'
        }], [{a: 1, field: 1}]],
        ...
        }, [{text: ['Bob', 'Melissa', 'Joe', 'Sherry']}], [{text: ['Bob', 'Melissa', 'Joe', 'Sherry']}]],
        ...
        }, [{a: {b: 'exists'}}, {a: {c: 'does not exist'}}], [{a: {b: 'exists'}}]],
        ...
        [
            {a: {$elemMatch: {b: 1, c: 2}}},
            [{a: {b: 1, c: 2}}, {a: [{b: 1, c: 2, d: 3}]}, {a: {b: 2, c: 3}}], [{a: {b: 1, c: 2}}, {
            a: [{
                b: 1,
                c: 2,
                d: 3
        ...
        [{a: {$elemMatch: {b: 2, c: {$gt: 2}}}}, [{a: {b: 1, c: 2}}, {a: {b: 1, c: 2, d: 3}}, [{
            a: {
                b: 2,
                c: 3
            }
